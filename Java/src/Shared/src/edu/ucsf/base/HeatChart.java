...
public class HeatChart {
	...
	private Color errorValueColour;
	...
	public HeatChart(double[][] zValues, double low, double high) {
		...
		this.errorValueColour=this.backgroundColour;
	...
	/**
	 * Sets the colour to be used for errors
	 * 
	 * <p>
	...
	public void setErrorColour(Color errorColour) {
		if (errorValueColour == null) {
			errorValueColour = Color.WHITE;
		}
		
		this.errorValueColour = errorColour;
	}
		...
		for (int x=0; x<noXCells; x++) {
			for (int y=0; y<noYCells; y++) {
				...
				//error	
					...
					// Set colour depending on zValues.
					heatMapGraphics.setColor(errorValueColour);
